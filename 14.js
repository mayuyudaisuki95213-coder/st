...
highly detailed, masterpiece, best quality
    ...
    async function callNovelAIForImage(prompt, params = {}) {
        ...
        // 根据模型类型构建不同的请求体
        let requestBody;
        if (settings.novelaiModel.includes('nai-diffusion-4-5')) {
            // v4.5 模型使用新的参数结构
            requestBody = {
                input: prompt,
                ...
                parameters: {
                    ...
                    noise_schedule: finalParams.scheduler,
                    ...
                    image_format: 'png',
                    sm: finalParams.sm,
                    sm_dyn: finalParams.sm_dyn,
                    dynamic_thresholding: finalParams.decrisper,
                    cfg_rescale: finalParams.cfg_rescale,
                    qualityToggle: finalParams.qualityToggle,
                    autoSmea: finalParams.autoSmea,
                    skip_cfg_above_sigma: finalParams.variety_boost ? Math.pow((finalParams.width * finalParams.height) / 1011712, 0.5) * 58 : null,
                    sigma_algo: "karras",
                    post_processing: [],
                    v4_prompt: {
                        caption: {
                    ...
                    v4_negative_prompt: {
                        caption: {
                            base_caption: settings.novelaiNegative,
                            char_captions: []
                        },
                        legacy_uc: false
                    },
                    negative_prompt: settings.novelaiNegative,
                    ucPreset: finalParams.ucPreset,
                    variety_boost: finalParams.variety_boost,
        ...
        try {
            ...
            // NovelAI API 返回的是二进制数据，需要转换为 base64
