                    ...
                    <div class="sd-api-row">
                        ...
                        <div style="display: flex; gap: 8px; align-items: center;">
                            <select id="sd-novelai-model" class="text_pole" style="flex: 1;">
                                <option value="${settings.novelaiModel}">${settings.novelaiModel}</option>
                            </select>
                ...
                try {
                    ...
                    if (models && Array.isArray(models)) {
                        models.forEach(model => {
                            ...
                            $select.append(`<option value="${modelName}" ${modelName === settings.novelaiModel ? 'selected' : ''}>${modelName}</option>`);
                        });
