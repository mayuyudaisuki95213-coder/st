...
highly detailed, masterpiece, best quality
            ...
            try {
                ...
                if (settings.novelaiEnabled && settings.novelaiApiKey) {
                    ...
                    const novelaiParams = {
                        ...
                        dynamicThresholding: settings.novelaiParameters.dynamicThresholding
                    };
    ...
    async function callNovelAIApi(params, apiKey) {
        try {
            ...
            const payload = {
                input: params.input,
                model: params.model || settings.novelaiModel,
                ...
                seed: params.seed || settings.novelaiParameters.seed,
                ...
                dynamicThresholding: params.dynamicThresholding !== undefined ? params.dynamicThresholding : settings.novelaiParameters.dynamicThresholding,
                ...
                // 添加图片尺寸参数
                width: params.width || settings.novelaiParameters.width || 1024,
                height: params.height || settings.novelaiParameters.height || 1024
            };

            // 如果seed为-1，生成随机种子
            if (payload.seed === -1) {
                payload.seed = Math.floor(Math.random() * 999999999);
            }

            // 添加负面提示词
            if (params.negative_prompt) {
                payload.input += ` {bad hands}, {bad feet}, {bad fingers}, {low quality}, {bad anatomy}, {missing limbs}, {extra limbs}, {malformed limbs}, {fused fingers}, {too many fingers}, {bad eyes}, {unclear eyes}, {low detail}, {simple background}, {blurry}, {duplicate}, {error}, {out of frame}, {watermark}, {signature}, {text}, ${params.negative_prompt}`;
            } else {
                payload.input += ` {bad hands}, {bad feet}, {bad fingers}, {low quality}, {bad anatomy}, {missing limbs}, {extra limbs}, {malformed limbs}, {fused fingers}, {too many fingers}, {bad eyes}, {unclear eyes}, {low detail}, {simple background}, {blurry}, {duplicate}, {error}, {out of frame}, {watermark}, {signature}, {text}, ${settings.globalNegative}`;
            }
            ...
            $('#sd-test-novelai-api').on('click', async function () {
                ...
                try {
                    ...
                    const testParams = {
                        ...
                        dynamicThresholding: $('#sd-novelai-dyn-threshold').is(':checked'),
