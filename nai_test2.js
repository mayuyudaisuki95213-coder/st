...
(function () {
    ...
    const NOVELAI_MODELS = [
        ...
        { label: 'NAI Diffusion Furry', value: 'nai-diffusion-furry' },
        { label: 'NAI Diffusion V1', value: 'nai-diffusion' },
        { label: 'Safe Diffusion', value: 'safe-diffusion' }
    ];
...
highly detailed, masterpiece, best quality
    ...
    const DEFAULT_SETTINGS = {
        ...
        novelaiConfig: {
            ...
            qualityToggle: true,
            ucPreset: 0,
            negativePrompt: 'nsfw, lowres, {bad}, error, fewer, extra, missing, worst quality, jpeg artifacts, bad quality, watermark, unfinished, displeasing, chromatic aberration, signature, extra digits, artistic error, username, scan, [abstract]'
        },
