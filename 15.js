            ...
            for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
                try {
                    ...
                    if (result) {
                        ...
                        const uniqueImages = [...new Set([...state.images, result])];
        ...
        const html = `
            <div class="sd-settings-popup" style="display: flex; flex-direction: column; max-height: 78vh;">
                ...
                <div id="sd-tab-novelai" class="sd-tab-content">
                    ...
                    <button id="sd-test-novelai" class="sd-btn-secondary" style="width:100%; margin-top:20px;">🧪 测试 NovelAI 连接</button>
                </div>
        ...
        setTimeout(() => {
            ...
            $('#sd-test-novelai').on('click', async function () {
                ...
                try {
                    ...
                    // 使用简单的测试提示词
                    await callNovelAIForImage('1 girl, smiling, blue sky, tree', {
                        width: 640,
                        height: 480,
